        ...
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <a href="main.php" class="btn btn-primary" data-toggle="modal"><i
            ...
            <table class="table table-striped table-hover">
                ...
                $json=file_get_contents('http://192.168.0.27:8081/web_api/user.php/?user');
                ...
                ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="edit.php?id=<?=$row->userid?>&username=<?=$row->username?>&email=<?=$row->email?>&password=<?=$row->password?>"
                                class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip"
                                    title="Edit">&#xE254;</i></a>
                            <a href="http://192.168.0.27:8081/web_api/user.php/?delete=<?=$row->userid?>&page=http://localhost:8081/webapi/table.php"
