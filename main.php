...
<body>
    ...
    <div class="app">
        ...
        <div class="intro_viewer">
            ...
            <h2 class="none">Be part of us!</h2>
            <p class="none">Add User Now</p>
            <div class="img none">
        ...
        <form  action="http://192.168.0.27:8081/web_api/user.php" method="POST">
            ...
            <button  style=" padding: 15px;text-decoration: none; border-radius:20px; background-color:#233e8b;color:white;" href="table.php"  type="submit" name="add" class=three> SUBMIT</button>
        </form>
